    ...
    <div className="fixed inset-0 z-10 bg-black bg-opacity-50 flex items-center justify-center">
      <Card fullWidth={false} additionalClasses={" px-14"}>
        <form className="flex flex-col pb-6">
          ...
          <div className="flex flex-col w-3/5">
            ...
            <div className="mt-1 relative rounded-md bg-transparent w-full">
              <div className=" absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                <span className=" text-gray-500 text-md dark:bg-transparent items-center self-center">
              ...
              <div className="absolute inset-y-0 right-0 flex justify-end items-center">
                <select
                  ...
                  className="focus:ring-indigo-400 focus:border-indigo-400 focus:border-2 focus:outline-none h-9 pr-7 border-transparent bg-transparent text-gray-400 sm:text-sm rounded-md"
                >
                  <option>EUR</option>
                  <option>USD</option>
                  <option>ZAR</option>
            ...
            <label className="flex justify-between items-center cursor-pointer mt-8 mb-7 ">
              <label className="text-sm dark:text-gray-300 text-gray-800">
                Recurring
              </label>
              <div className="relative mr-1.5">
                <input className="form-input hidden" type="checkbox" />
          ...
          <label className="">Recurring type</label>
          <select className="bg-transparent dark:text-gray-400 dark:focus:text-gray-300  form-input border-2 dark:border-400 font-base">
